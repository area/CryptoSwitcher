...
coins['dbl'] =  Coin('Doubloons') # Listed against LTC only
...
coins['gld'] =  Coin('GLDCoin') # Listed against LTC only
coins['hyc'] =  Coin('Hypercoin')
coins['jkc'] =  Coin('Junkcoin') # Listed against LTC only
coins['lky'] =  Coin('Luckycoin')
coins['ltc'] =  Coin('Litecoin')
coins['mec'] =  Coin('Megacoin') # Unavailable on coinchoose.
coins['mem'] =  Coin('Memecoin')
coins['mnc'] =  Coin('Mincoin')
coins['nbl'] =  Coin('Nibble')
coins['nvc'] =  Coin('NovaCoin')
coins['ppc'] =  Coin('PPCoin')
coins['pwc'] =  Coin('Powercoin') # Removed from everywhere?
coins['pxc'] =  Coin('Phenixcoin')
coins['ryc'] =  Coin('RoyalCoin') # Listed against LTC only
coins['trc'] =  Coin('TerraCoin')
coins['wdc'] =  Coin('Worldcoin')
coins['yac'] =  Coin('YaCoin') # Unavailable on coinchoose.
# Merged
